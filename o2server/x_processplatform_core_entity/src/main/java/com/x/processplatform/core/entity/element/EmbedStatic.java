...
@StaticMetamodel(Embed.class)
public class EmbedStatic extends SliceJpaObjectStatic {
    ...
    public static volatile SingularAttribute<Embed, String> displayLogScript;
    public static volatile SingularAttribute<Embed, String> displayLogScriptText;
    public static volatile SingularAttribute<Embed, String> edition;
    ...
    public static volatile SingularAttribute<Embed, String> group;
    ...
    public static volatile SingularAttribute<Embed, String> opinionGroup;
    ...
    public static volatile SingularAttribute<Embed, EmbedProperties> properties;
    ...
    public static volatile SingularAttribute<Embed, Boolean> waitUntilCompleted;
