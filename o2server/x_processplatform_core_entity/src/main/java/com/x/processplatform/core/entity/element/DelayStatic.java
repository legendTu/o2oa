...
@StaticMetamodel(Delay.class)
public class DelayStatic extends SliceJpaObjectStatic {
    ...
    public static volatile SingularAttribute<Delay, String> displayLogScript;
    public static volatile SingularAttribute<Delay, String> displayLogScriptText;
    public static volatile SingularAttribute<Delay, String> edition;
    ...
    public static volatile SingularAttribute<Delay, String> group;
    public static volatile SingularAttribute<Delay, String> id;
    public static volatile SingularAttribute<Delay, String> name;
    public static volatile SingularAttribute<Delay, String> opinionGroup;
    ...
    public static volatile SingularAttribute<Delay, DelayProperties> properties;
