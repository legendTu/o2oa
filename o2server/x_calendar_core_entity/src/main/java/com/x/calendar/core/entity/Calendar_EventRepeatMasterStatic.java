...
@StaticMetamodel(Calendar_EventRepeatMaster.class)
public class Calendar_EventRepeatMasterStatic extends SliceJpaObjectStatic {
    ...
    public static volatile SingularAttribute<Calendar_EventRepeatMaster, String> commentId;
    ...
    public Calendar_EventRepeatMasterStatic() {
    }
}
