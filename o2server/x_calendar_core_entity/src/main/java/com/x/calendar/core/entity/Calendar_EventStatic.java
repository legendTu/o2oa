...
@StaticMetamodel(Calendar_Event.class)
public class Calendar_EventStatic extends SliceJpaObjectStatic {
    ...
    public static volatile SingularAttribute<Calendar_Event, String> commentId;
