...
@StaticMetamodel(BBSSubjectInfo.class)
public class BBSSubjectInfoStatic extends SliceJpaObjectStatic {
    public static volatile SingularAttribute<BBSSubjectInfo, String> acceptReplyId;
    public static volatile SingularAttribute<BBSSubjectInfo, Boolean> anonymousSubject;
    ...
    public static volatile ListAttribute<BBSSubjectInfo, String> editorList;
    ...
    public static volatile SingularAttribute<BBSSubjectInfo, Integer> grade;
    ...
    public static volatile SingularAttribute<BBSSubjectInfo, String> lastUpdateUser;
    ...
    public static volatile SingularAttribute<BBSSubjectInfo, String> nickName;
